...
| UI 框架 | `ui/tokens.py`、`ui/theme.py`、`ui/components.py`、`ui/shell.py`、`ui/timeline.py`、`ui/render.py`、`ui/dialogs.py` | V6 设计令牌、主题绑定、基础组件、左导航+Router、学习时间轴（PIL 锐利化）、3x 超采样渲染工具、外迁对话框（在线导入/训练报告，app.py 瘦身模式）。 |
