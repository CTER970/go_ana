...
- 可导出 Markdown 复盘报告，其中包含阶段表现、问题手、双分支对比、错误链/问题簇和文字总结。
...
| UI 框架 | `ui/tokens.py`、`ui/theme.py`、`ui/components.py`、`ui/shell.py`、`ui/timeline.py`、`ui/render.py` | V6 设计令牌、主题绑定、基础组件、左导航+Router、学习时间轴（PIL 锐利化）、3x 超采样渲染工具。 |
| UI 页面 | `ui/pages/home.py`、`ui/pages/library.py`、`ui/pages/practice.py`、`ui/pages/learning.py` | 今日学习首页、棋谱一级页面、复习一级页面（Phase 7）、我的学习一级页面（Phase 8）。 |
